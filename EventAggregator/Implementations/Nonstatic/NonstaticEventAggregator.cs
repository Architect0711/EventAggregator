...
namespace EventAggregator.Implementations.Nonstatic
{
    /// <summary>
    /// Nonstatic Implementation of the EventAggregator Pattern
    /// Stores Weak References to the Callbacks to prevent Memory Leaks 
    /// Meant to be used with Dependency Injection
    /// Register as Singleton
    /// </summary>
    public sealed class NonstaticEventAggregator : IEventAggregator
    {
